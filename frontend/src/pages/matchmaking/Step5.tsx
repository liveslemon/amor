...
const bodyTypeIcons: Record<string, React.ReactNode> = {
  Slim: (
    <svg viewBox="0 0 40 80" className="w-5 h-8" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function Step5() {
  ...
  const [maxAge, setMaxAge] = useState((answers.preferred_max_age as string) || '22');
