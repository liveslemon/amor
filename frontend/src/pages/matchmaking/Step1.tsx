...
const bodyTypeIcons: Record<string, React.ReactNode> = {
  ...
  Petite: (
    <svg
      ...
      strokeLinejoin="round"
    >
      {/* Petite female torso - small, narrow */}
  ...
  Athletic: (
    <svg
      ...
      strokeLinejoin="round"
    >
      {/* Athletic male torso - defined with abs */}
  ...
  Muscular: (
    <svg
      ...
      strokeLinejoin="round"
    >
      {/* Muscular male torso - broad, defined */}
  ...
  "Plus-size": (
    <svg
      ...
      strokeLinejoin="round"
    >
      {/* Plus-size female torso - wider, fuller */}
