    ...
    if (navigator.share) {
      try {
        await navigator.share({
          ...
          text: `I just joined ${APP_CONFIG.name} to get curated dates every Wednesday!`,
        ...
        <main className="max-w-xl w-full z-10 flex flex-col items-center">
          ...
          >
            ...
            <h1 className="text-3xl md:text-4xl font-serif tracking-tight mb-4">
              ...
              <span className="italic font-light text-white/90">{APP_CONFIG.name} 🎉</span>
            </h1>
            ...
            <div className="w-full flex flex-col gap-5 border-y border-white/5 py-6 mb-10 text-left max-w-sm">
              <div className="flex items-start gap-3">
                ...
                <p className="text-white/70 text-sm leading-relaxed font-light">
                  <strong className="text-white font-medium">Weekly Matches:</strong> We carefully curate and send your matches directly to you every Wednesday.
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="text-base mt-0.5">🔔</div>
                <p className="text-white/70 text-sm leading-relaxed font-light">
                  <strong className="text-white font-medium">Stay Alerted:</strong> No further action is needed for now—keep an eye on your messages.
                </p>
              </div>
            </div>
