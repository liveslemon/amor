...
export default function SignUp() {
  ...
  const [formData, setFormData] = useState({ name: '', whatsapp_number: '', password: '' });
        ...
        <div className="max-w-xl w-full z-10 flex flex-col mt-4">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-serif tracking-tight leading-[1.1] mb-6 mt-4">
              Create your <br />
              <span className="italic font-light text-white/90">{APP_CONFIG.name} Profile</span>
            </h1>

            <p className="text-base md:text-lg text-white/50 mb-8 font-sans font-light max-w-sm mx-auto leading-relaxed">
              {isSuccess ? 'Account created successfully!' : 'Join the waitlist and let our algorithm curate your perfect Wednesday date. No swiping. No ghosting.'}
            </p>
              ...
              >
                <div className="w-20 h-20 bg-emerald-500/20 border border-emerald-500/30 rounded-full flex items-center justify-center mb-4">
                  <motion.svg 
                    ...
                    xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}
                  >
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </motion.svg>
                </div>
                <h2 className="text-2xl font-serif text-white mb-1">Welcome, {formData.name}!</h2>
                <p className="text-white/40 text-sm font-sans">Taking you to onboarding...</p>
              </motion.div>
            ) : (
